  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-slate-50 to-blue-100 flex flex-col">
      ...
      <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 px-8 pt-12 pb-20 rounded-b-[3rem] shadow-2xl">
        ...
        <p className="text-blue-100">Login to continue your loan journey</p>
      </div>
      ...
      <div className="flex-1 px-8 py-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Email */}
          <div className="bg-white rounded-3xl p-6 space-y-3 border-2 border-slate-200 shadow-lg">
          ...
          <div className="pt-4">
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-yellow-400 to-amber-500 hover:from-yellow-500 hover:to-amber-600 text-slate-900 h-14 text-lg rounded-2xl font-bold shadow-xl"
            >
              Login
            </Button>
          </div>
